...
const SearchDeployed = () => {
  const [isOpen, setIsOpen] = useState<boolean>(false);
  const toggleMenu = () => setIsOpen(!isOpen);
  return (
    <div className=" shadow-md  ">
      <div className="app-container flex gap-4">
      ...
      <div className=" relative m-auto container pt-4 pr-4 pl-4  lg:max-w-6xl flex gap-6 subtitle-2 text-app-grayDark">
        ...
        <button className="hidden sm:block focus:border-b-4 focus:border-app-blue">
